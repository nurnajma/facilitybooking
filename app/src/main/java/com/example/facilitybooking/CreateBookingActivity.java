...
public class CreateBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get facility from intent
        Intent intent = getIntent();
        int facilityID = intent.getIntExtra("facilityID", -1);
        String facilityName = intent.getStringExtra("facilityName");
        int capacity = intent.getIntExtra("capacity", 0);
        double hourlyRate = intent.getDoubleExtra("hourlyRate", 0.0);
        ...
        tvFacilityInfo.setText("Capacity: " + facility.getCapacity() + " | Rate: RM " +
                String.format("%.2f", facility.getHourlyRate()) + "/hr");
    ...
    private void submitBooking() {
        ...
        Call<Booking> call = bookingService.createBooking(
                user.getToken(),
                user.getId(),
        ...
        call.enqueue(new Callback<Booking>() {
            ...
            public void onResponse(Call<Booking> call, Response<Booking> response) {
                if (response.code() == 201 || response.code() == 200) {
                    Toast.makeText(CreateBookingActivity.this,
                            "Booking submitted successfully!", Toast.LENGTH_LONG).show();
                    finish();
                } else {
                    Toast.makeText(CreateBookingActivity.this,
            ...
            public void onFailure(Call<Booking> call, Throwable t) {
                ...
                Log.e("CreateBooking", "Error: " + t.getMessage());
            }
        });
    }
}